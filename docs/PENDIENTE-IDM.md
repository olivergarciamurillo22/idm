...
| 31 | **Motor OCR definitivo**: Tesseract local es prototipo (docs/benchmark-lector-real.md). Decidir tras 20 albaranes más y la respuesta al punto 20 | Lector de imagen de producción | `albaranes/ocr` | Alta (hito 3) | **Nuevo** → Ángel (punto 20) + benchmark |
