...
def main() -> None:
    hoja(
        ...
        [
            ...
            ["900.000.842", "TERMINAL FASTON H. 9,4 AMAR", "UD", 9001, 0.30, 45, 100, "Comercial"],
            ["Z33.000.786", "RODAMIENTO 6205 2RS", "UD", 9001, 9.14, 45, 1, "Comercial"],
            ["P20.000.010", "CORTE TUBO 80x80x3 L=1200", "UD", None, 12.50, 0, 1, "MP"],
            ["P20.000.011", "CHAPA KG 3MM", "KG", None, 1.20, 0, 1, "MP"],
            ["SV09001", "SERVICIO FICTICIO (CONTRATOS)", "UD", 9002, None, 0, 1, "Comercial"],
        ],
    )
    hoja(
    ...
    hoja(
        ...
        [
            ["900.000.842", 9001, "FXT9550942", "TERMINAL FASTON H 9,4 AMARILLO"],
            ["Z33.000.786", 9001, "ABR-6205", "RODAMIENTO 6205 2RS"],
            ["I37.000.012", 9001, "MNG-12", "MANGUERA HIDRAULICA 1/2"],
            ["SV09001", 9002, "SV09001", "SERVICIO FICTICIO (CONTRATOS)"],
    ...
    hoja(
        ...
        [
            ...
            [20269060, 9001, "2026-09-10", "Z33.000.786", "RODAMIENTO 6205 2RS", 5, "UD", 9.14, 45, 0, "ABR-6205"],
            [20269060, 9001, "2026-09-10", "I37.000.012", "MANG. HIDR. 1/2", 5, "M", 6.40, 0, 0, "MNG-12"],
            [20269061, 9003, "2026-09-11", "I34.000.900", "RELE 24V 40A", 12, "UD", 3.10, 10, 0, "EL-REL-24"],
            [20269061, 9003, "2026-09-11", "T30.000.100", "TORNILLO M10x30", 100, "UD", 0.08, 0, 0, "EL-TOR-1030"],
            [20269055, 9002, "2026-09-01", "H50.000.020", "BOMBA HIDRAULICA 20L", 2, "UD", 210.00, 0, 2, None],
        ],
    )
    hoja(
        AQUI / "stock.xlsx",
