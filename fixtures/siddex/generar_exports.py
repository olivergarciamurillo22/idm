"""Genera los exports ficticios de Siddex en fixtures/siddex/ (articulos, proveedores, fabricantes, pedidos, stock)
y un planning ficticio en fixtures/planning_ficticio.xlsx con la misma estructura que el real (hoja, filas 5+, B..E).
Ejecutar: PYTHONPATH=src .venv/bin/python fixtures/siddex/generar_exports.py"""
...
def main() -> None:
    ...
    hoja(AQUI / "proveedores.xlsx", ["Código", "Nombre", "CIF", "Email"],
         [
    ...
    hoja(AQUI / "fabricantes.xlsx", ["Código", "Proveedor", "Código alternativo", "Descripción proveedor"],
         [
    ...
    hoja(AQUI / "pedidos.xlsx",
         ["Pedido", "Proveedor", "Fecha", "Artículo", "Descripción", "Cantidad", "Unidad", "Precio", "Dto",
          "Recibida", "Referencia proveedor"],
         [
             [20261060, 9001, "2026-09-10", "134.000.842", "TERMINAL FASTON H. 9,4 AMAR", 100, "UD", 0.30, 45, 0, "PVCC550942"],
    ...
    hoja(AQUI / "stock.xlsx", ["Código", "Stock"],
